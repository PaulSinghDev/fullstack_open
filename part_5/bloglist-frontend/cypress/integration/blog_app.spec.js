describe('Blog app', function () {
  ...
  it('has blogs ordered by likes, descending', function () {
    ...
    cy.get('.blog .show-more').click({ multiple: true })
  ...
  describe('login tests', function () {
    it('has correct credentials', function () {
      ...
      cy.contains('You are logged in as cypress')
      cy.get('.notification-modal')
        .should('have.css', 'border', '1px solid rgb(0, 128, 0)')
        .and('contain', 'You have been logged in')
    })
  ...
  describe('when logged in', function () {
    ...
    it('cannot delete blog of others', function () {
      cy.createBlog({
        title: "Can't Delete",
        author: 'undeleteable',
